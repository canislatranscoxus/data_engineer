...
def transform_data( ds, **kwargs):
    ...
    # AAT. Filter Invoices where invoice.date = execution date.
    filtered_data = invoices_data[ invoices_data[ 'InvoiceDate' ] == f'{ ds }' ]

    filtered_data.to_csv(path_or_buf=transformed_path)
